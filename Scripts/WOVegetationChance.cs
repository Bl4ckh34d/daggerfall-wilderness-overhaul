    ...
    public class WOVegetationChance
    {
        ...
        public void ChangeVegetationChances(float elevation, int climate)
        {
            ...
            else
            {
                ...
                if (climate == (int)MapsFile.Climates.Mountain)
                {
                ...
                else
                {
                    ...
                    if (climate == (int)MapsFile.Climates.Desert)
                    {
                    ...
                    {
                        //Adjustment to desert climate in respect to world height
                        if (climate == (int)MapsFile.Climates.Desert2)
                        {
                        ...
                        else
                        {
                            ...
                            if (climate == (int)MapsFile.Climates.HauntedWoodlands)
                            {
                            ...
                            else
                            {
                                ...
                                if (climate == (int)MapsFile.Climates.MountainWoods)
                                {
                                    if (elevation > 0.475f)
                                    {
